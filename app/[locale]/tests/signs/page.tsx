// path: app/[locale]/tests/signs/page.tsx
...
const GROUPS = [
  { key: "warning", en: "Warning signs", fa: "علائم اخطاری" },
  { key: "regulatory", en: "Regulatory signs", fa: "علائم انتظامی/دستوری" },
  { key: "info", en: "Information signs", fa: "علائم اطلاعاتی" },
];
...
export default function SignsPage({
  ...
  const t = {
    badge: { en: "Road Signs", fa: "علائم رانندگی" },
    title: { en: "Learn UK Road Signs", fa: "یادگیری علائم رانندگی بریتانیا" },
    lead: {
      en: "Browse by category. Flashcards and quizzes coming soon.",
      fa: "مرور بر اساس دسته‌بندی. فلش‌کارت و کوییز به‌زودی.",
    },
          ...
          {GROUPS.map((g) => (
            <div key={g.key}
              ...
              <div className="flex items-center justify-between">
                <div className="font-medium">{locale === "fa" ? g.fa : g.en}</div>
